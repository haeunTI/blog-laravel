...
class AgentItemController extends Controller
{
    public function GetAllProperty() {
        ...
        $id = Auth::user()->id;
        $item = Item::where("id_agent", $id)->latest()->get();

        return view("agent.item.all", [
            "data" => $item
        ]);
    }
    ...
    public function AddData(Request $req) {
        ...
        return redirect('/agent/all/item');
    }
