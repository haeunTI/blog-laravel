...
<h1 style="color:#199e59;direction:ltr;font-family:'Roboto Slab', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:74px;font-weight:700;letter-spacing:normal;line-height:120%;text-align:left;margin-top:0;margin-bottom:0;">Realestate<br/> </h1>
</div>
...
<div class="bee-block bee-block-1 bee-paragraph">
<p><strong>Hello {{$jadwal->User->name}} </strong><br/><strong>Your Request is confirm on this data. Kindly visit our office in Jl. Imam Bonjol No.6 to be guided for the tour!</strong></p>

<h4>Tanggal Tour: {{$jadwal->tanggal_tour}}</h4>
<h4>Waktu Tour: {{$jadwal->waktu_tour}}</h4>
