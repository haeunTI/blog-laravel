...
<nav class="page-breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="{{route('agent.item.tambah')}}">Tambah</a></li>
					</ol>
				</nav>
                  ...
                  <table id="dataTableExample" class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="{{ route('agent.item.edit', $item->id) }}">Edit</a> / <a id="delete" href="{{ route('agent.item.hapus', $item->id) }}">Hapus</a></td>
                        <td><a href="{{ route('agent.item.rinci', $item->id) }}">View</a></td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
