                                ...
                                <form action="{{ route('item.cari.semua') }}" method="POST">
                                    ...
                                    <div class="widget-content">
                                        <div class="select-box">
                                            ...
                                            <option data-display="Semua Status">Semua Status</option>
                                        ...
                                        <div class="select-box" name="ruang" id="ruang">
                                            <select class="wide">
                                    ...
                                    <div class="deals-block-one">
                                        <div class="inner-box">
                                            <div class="image-box">
                                                ...
                                                @endif
                                                <span class="kota">{{$item['kota']}}</span>
                                                <div class="buy-btn"><a href="property-details.html">Di{{ $item['status_property'] }}</a></div>
                                            </div>
                                            <div class="lower-content">
                                                <div class="title-text"><h4><a href="property-details.html">{{ $item['nama_property'] }}</a></h4></div>
