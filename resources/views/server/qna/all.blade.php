              ...
              <div class="card-body">
                <div class="row">
                    ...
                    <div class="email-aside-nav collapse">
                      <ul class="nav flex-column">
                        <li class="nav-item {{ $for == 'inbox' ? 'active' : '' }}">
                          <a class="nav-link d-flex align-items-center" href="{{ route('admin.qna') }}">
                        ...
                        <li class="nav-item {{ $for == 'all' ? 'active' : '' }}">
                          <a class="nav-link d-flex align-items-center" href="{{ route('admin.qnaAll') }}">
                            <i data-feather="inbox" class="icon-lg me-2"></i>
                            All
                            @if ($for == "all")
                            <span class="badge bg-danger fw-bolder ms-auto">{{ count($data) }}                              
                        ...
                        <li class="nav-item {{ $for == 'contactus' ? 'active' : '' }}">
                          <a class="nav-link d-flex align-items-center" href="{{ route('admin.contactus') }}">
                            <i data-feather="inbox" class="icon-lg me-2"></i>
                            Contact Us
                            @if ($for == "contactus")
                            <span class="badge bg-danger fw-bolder ms-auto">{{ count($data) }}                              
                  ...
                  <div class="col-lg-9">
                    ...
                    <a href="{{ $for !== 'contactus' ? route('admin.qna.baca', $qna->id) : route('admin.contactus.baca', $qna->id) }}" class="email-list-detail">
                          <div class="content">
