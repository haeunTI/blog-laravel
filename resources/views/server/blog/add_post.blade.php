...
<div class="page-content">
    ...
    <div class="col-md-12 col-xl-12 middle-wrapper">
        ...
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Tambah Post</h6>
                    <form class="forms-sample" method="POST" action="{{ route('post.publish.data') }}" enctype="multipart/form-data" id="myForm">
                    @csrf
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3 form-group">
                                    <label for="judul" class="form-label">Judul</label>
                                    <input type="text" name="judul" class="form-control" id="judul" autocomplete="off" @error('judul') is-invalid @enderror>
                                    @error('judul')
