...
<div class="page-content">
    ...
    <div class="col-md-12 col-xl-12 middle-wrapper">
        ...
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Ubah Property</h6>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="hidden" name="old_pict_property" value="{{ $data->pict_property}}">
                                    @error('pict_property')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 form-group">
                                    ...
                                    <select class="form-select" id="id_agent" name="id_agent">
                                        ...
                                        @foreach ($agents as $agent )
                                            <option value="{{ $agent->id }}" {{ $data->id_agent == $agent->id ? "selected" : " "}}>{{ $agent->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('id_agent')
                                        <span class="text-danger">{{ $message }}</span>
        ...
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Multi Image</h6>
                    <form class="forms-sample" method="POST" action="{{ route('item.edit.multi') }}" enctype="multipart/form-data" id="myForm">
                    @csrf
                    <input type="hidden" name="id_item" value="{{$data->id}}">
										...
										<tbody>
                                            ...
                                            <tr>
												...
												<td>
                                                    ...
                                                    <a href="{{ route('item.multi.hapus', $image->id) }}" class="btn btn-danger">Delete</a>
                                                </td>
											</tr>  
                                            @endforeach
                    ...
                    <form class="forms-sample" method="POST" action="{{ route('item.tambah.multi') }}" enctype="multipart/form-data" id="myForm">
                    @csrf
                    <input type="hidden" name="id_item" value="{{$data->id}}">
                    <table class="table table-striped">
                        <tr>
        ...
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Fasilitas</h6>
                    <form class="forms-sample" method="POST" action="{{ route('item.edit.fasilitas') }}" enctype="multipart/form-data" id="myForm">
                        @csrf
                        <input type="hidden" name="id_item" value="{{$data->id}}">
